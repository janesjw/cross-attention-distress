...
|---|---|---|
| SSE and SZSE | Current and delisted A-share registers | [SSE](https://www.sse.com.cn/assortment/stock/list/share/), [SZSE](https://www.szse.cn/market/product/stock/list/index.html) |
| SZSE name changes | Effective dates and names before/after each change | [Name changes](https://www.szse.cn/market/stock/changename/index.html) |
...
Exchange downloads dated September 9, 2026 are preserved in `data/raw/market_sources.zip`. `python analysis/import_market.py --output market_records.json` reproduces their normalized records. Historical industry changes, relistings and code changes require further review before final membership is approved.
